...
inputDirectory <- file.path(workingDirectory, 'Input', 'low_rep', generator)
...
outputDirectory <- file.path(workingDirectory, 'Output', 'low_rep', generator)
outputString <- paste(inputString, "Maaslin3CompAdjustStrata", sep="_")
